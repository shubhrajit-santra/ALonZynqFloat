...
*************** Arm-Learning Algorithm Implementation on Zynq ***************

--> This repository contains all the source codes and a block diagram of the architecture for the Zynq implementation of the multi-armed bandit (MAB) arm-learning algorithm.
